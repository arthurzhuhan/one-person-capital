...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@one-person-capital/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@one-person-capital/adapter-utils").TranscriptEntry[];
