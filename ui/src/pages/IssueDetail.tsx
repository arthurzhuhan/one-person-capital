...
import type { ActivityEvent } from "@one-person-capital/shared";
import type { Agent, IssueAttachment } from "@one-person-capital/shared";
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`one_person_capital:issue-comment-draft:${issue.id}`}
            enableReassign
