...
import type { Agent, Issue } from "@one-person-capital/shared";
...
export function Dashboard() {
  ...
  if (!selectedCompanyId) {
    ...
    return (
      <EmptyState icon={LayoutDashboard} message={t("dashboard.selectToView")} />
    );
  }
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t("dashboard.budgetOf", { budget: formatCents(data.costs.monthBudgetCents) })
