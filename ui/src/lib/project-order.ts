import type { Project } from "@one-person-capital/shared";

export const PROJECT_ORDER_UPDATED_EVENT = "one_person_capital:project-order-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "one_person_capital.projectOrder";
