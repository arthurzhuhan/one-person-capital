...
import type { Approval, DashboardSummary, HeartbeatRun, Issue, JoinRequest } from "@one-person-capital/shared";
import {
...
describe("inbox helpers", () => {
  ...
  it("maps legacy new-tab storage to recent", () => {
    localStorage.setItem("one_person_capital:inbox:last-tab", "new");
    expect(loadLastInboxTab()).toBe("recent");
  });
});
