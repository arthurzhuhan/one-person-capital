...
import { buildProjectMentionHref, parseProjectMentionHref } from "@one-person-capital/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("one_person_capital-project-mention-chip");
      ...
      link.classList.add("one_person_capital-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative one_person_capital-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("one_person_capital-mdxeditor", !bordered && "one_person_capital-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "one_person_capital-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
