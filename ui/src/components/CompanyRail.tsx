...
import type { Company } from "@one-person-capital/shared";
import { CompanyPatternIcon } from "./CompanyPatternIcon";

const ORDER_STORAGE_KEY = "one_person_capital.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Building icon - aligned with top sections (implied line, no visible border) */}
