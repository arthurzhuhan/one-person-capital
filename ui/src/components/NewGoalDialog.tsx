...
import { GOAL_STATUSES, GOAL_LEVELS } from "@one-person-capital/shared";
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <DialogTitle asChild>
              <span>{newGoalDefaults.parentId ? t("common.newGoal") : t("common.newGoal")}</span>
            </DialogTitle>
            <DialogDescription className="sr-only">
              Create a new goal or sub-goal for the selected company.
            </DialogDescription>
          </div>
