...
const DRAFT_KEY = "one_person_capital:issue-draft";
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border shrink-0">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <DialogTitle asChild>
              <span>{t("common.newIssue")}</span>
            </DialogTitle>
            <DialogDescription className="sr-only">
              Create a new issue for the selected company.
            </DialogDescription>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <textarea
            className="w-full text-lg font-semibold bg-transparent outline-none resize-none overflow-hidden placeholder:text-muted-foreground/40 focus:ring-0"
