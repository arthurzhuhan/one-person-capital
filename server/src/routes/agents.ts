...
import { agents as agentsTable, companies, heartbeatRuns } from "@one-person-capital/db";
...
import { runClaudeLogin } from "@one-person-capital/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@one-person-capital/adapter-opencode-local/server";
...
export function agentRoutes(db: Db) {
  ...
  const strictSecretsMode = process.env.ONE_PERSON_CAPITAL_SECRETS_STRICT_MODE === "true";
