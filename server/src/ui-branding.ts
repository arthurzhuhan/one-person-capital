const FAVICON_BLOCK_START = "<!-- ONE_PERSON_CAPITAL_FAVICON_START -->";
const FAVICON_BLOCK_END = "<!-- ONE_PERSON_CAPITAL_FAVICON_END -->";
...
export function isWorktreeUiBrandingEnabled(env: NodeJS.ProcessEnv = process.env): boolean {
  return isTruthyEnvValue(env.ONE_PERSON_CAPITAL_IN_WORKTREE);
}
