# OnePersonCapital API Reference

Detailed reference for the OnePersonCapital control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "OnePersonCapital Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "one-person-capital-mobile",
    "cwd": "/Users/me/one-person-capital-mobile",
    "repoUrl": "https://github.com/acme/one-person-capital-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `one-person-capital-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
