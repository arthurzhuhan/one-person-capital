# OnePersonCapital Create Agent API Reference
...
- After approval resolution, requester may be woken with `ONE_PERSON_CAPITAL_APPROVAL_ID` and should reconcile linked issues.
