...
Environment overrides:
  ...
  PC_DATA=/tmp/data           One Person Capital data dir to use
  ONE_PERSON_CAPITAL_HOST=127.0.0.1    Host passed to the onboarded server
  ONE_PERSON_CAPITAL_PORT=3232         Port passed to the onboarded server
...
export PC_TEST_ROOT="${PC_TEST_ROOT:-$(mktemp -d /tmp/one_person_capital-clean-ref.XXXXXX)}"
export PC_HOME="${PC_HOME:-$PC_TEST_ROOT/home}"
export PC_CACHE="${PC_CACHE:-$PC_TEST_ROOT/npm-cache}"
export PC_DATA="${PC_DATA:-$PC_TEST_ROOT/one_person_capital-data}"
export PC_REPO="${PC_REPO:-$PC_TEST_ROOT/repo}"
export ONE_PERSON_CAPITAL_HOST="${ONE_PERSON_CAPITAL_HOST:-127.0.0.1}"
export ONE_PERSON_CAPITAL_PORT="${ONE_PERSON_CAPITAL_PORT:-3100}"
export ONE_PERSON_CAPITAL_OPEN_ON_LISTEN="${ONE_PERSON_CAPITAL_OPEN_ON_LISTEN:-false}"
...
echo "ONE_PERSON_CAPITAL_HOST: $ONE_PERSON_CAPITAL_HOST"
echo "ONE_PERSON_CAPITAL_PORT: $ONE_PERSON_CAPITAL_PORT"
...
env \
  ...
  HOST="$ONE_PERSON_CAPITAL_HOST" \
  PORT="$ONE_PERSON_CAPITAL_PORT" \
  ONE_PERSON_CAPITAL_OPEN_ON_LISTEN="$ONE_PERSON_CAPITAL_OPEN_ON_LISTEN" \
