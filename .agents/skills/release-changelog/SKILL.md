...
description: >
  Generate the stable OnePersonCapital release changelog at releases/v{version}.md by
...
```
- **Feature name** — Description. ([#123](https://github.com/one-person-capital/one-person-capital/pull/123), @contributor1, @contributor2)
```
