...
name: release
description: >
  Coordinate a full OnePersonCapital release across engineering verification, npm,
...
```bash
npm view one-person-capital@canary version
```
...
- any release summary in OnePersonCapital issue context
