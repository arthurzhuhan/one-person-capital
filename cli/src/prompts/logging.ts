...
import { resolveDefaultLogsDir, resolveOnePersonCapitalInstanceId } from "../config/home.js";

export async function promptLogging(): Promise<LoggingConfig> {
  const defaultLogDir = resolveDefaultLogsDir(resolveOnePersonCapitalInstanceId());
