...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" one_person_capital doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `one_person_capital configure --section database` or `one_person_capital onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadOnePersonCapitalEnvFile(input.configPath);
