...
- `ONE_PERSON_CAPITAL_APPROVAL_ID` — the resolved approval
- `ONE_PERSON_CAPITAL_APPROVAL_STATUS` — `approved` or `rejected`
- `ONE_PERSON_CAPITAL_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
