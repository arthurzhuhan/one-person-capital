...
- installed adapter list for this OnePersonCapital instance
...
## 8. New Skill: `one-person-capital-create-agent`

Create new skill directory:

- `skills/one-person-capital-create-agent/SKILL.md`
...
Also update `skills/one-person-capital/SKILL.md` to reference this skill for hiring workflows.
...
- `one-person-capital-create-agent` skill + docs updates
