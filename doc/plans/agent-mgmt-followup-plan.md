...
- `skills/one-person-capital/SKILL.md` and `skills/one-person-capital/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/one-person-capital/SKILL.md`
...
## 6.2 `skills/one-person-capital-create-agent/SKILL.md`
