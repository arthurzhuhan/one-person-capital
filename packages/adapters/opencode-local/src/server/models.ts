...
function resolveOpenCodeCommand(input: unknown): string {
  const envOverride =
    typeof process.env.ONE_PERSON_CAPITAL_OPENCODE_COMMAND === "string" &&
    process.env.ONE_PERSON_CAPITAL_OPENCODE_COMMAND.trim().length > 0
      ? process.env.ONE_PERSON_CAPITAL_OPENCODE_COMMAND.trim()
      : "opencode";
